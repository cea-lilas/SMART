...
class BinCatMassAperture(MassApertureMap):
    ...
    def bin_catalog(self, shear_catalog : ShearCatalog, SUM = False):
        ...
        start_time = time()
        pix_ind = hp.ang2pix(self.nside, shear_catalog.ra, shear_catalog.dec, nest=False, lonlat=True)
        ...
        self.verbose_print(2, f"Catalog binned in {time() - start_time:.2f} seconds.")
